...
SOURCES = \
	__init__.py \
	find_craters.py find_craters_dialog.py

PLUGINNAME = find_craters

PY_FILES = \
	__init__.py \
	find_craters.py find_craters_dialog.py

UI_FILES = find_craters_dialog_base.ui
...
QGISDIR=C:\Users\crist\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
